...
public class SQLConnection {
    ...
    private static String url = "jdbc:jtds:sqlserver://cronoplan.database.windows.net:1433;" +
            "databaseName=cronoplan;" +
            "user=azureadmin@cronoplan;" +
            "password=6VL_L#g&q&3Un,?>uFj{1.)N%o;" +
            "encrypt=true;" +
            "trustServerCertificate=false;" +
            "hostNameInCertificate=*.database.windows.net;" +
            "loginTimeout=30;ssl=request";//url = "jdbc:jtds:sqlserver://"+ip+":"+port+"/"+database; // the connection url string
